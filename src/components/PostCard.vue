...
<template>
  <div class="relative flex gap-4 mb-4 bg-gray-50 rounded shadow-md p-4 overflow-hidden">
    ...
    <div class="min-w-0 flex-1">
      ...
      <div class="mt-2 text-sm text-gray-700">
        <p class="text-justify text-ellipsis overflow-hidden truncate line-clamp-3">
          {{ post.text }}
        </p>
      </div>
    </div>
